...
public class IncomingCallActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mStringeeCall = StringeeService.getInstance().callsMap.get(callId);
        ...
        tvFrom.setText(mStringeeCall.getFromAlias());
    ...
    private void initAnswer() {
        ...
        mStringeeCall.initAnswer(this, StringeeService.getInstance().stringeeClient);
    }
